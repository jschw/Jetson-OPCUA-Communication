...
WORD_NeuralNetworkModelFilePath = 'model_curvetypes.h5'
...
while True:
    ...
    if DINT_Step == 0:
        ...
        try:
            ...
            model = keras.models.load_model(WORD_NeuralNetworkModelFilePath)
        ...
        REAL_Prediction = model.predict(REAL_InputVector)
        REAL_EndProcessing = time.time()


        REAL_PredictionConfidence = REAL_Prediction[0, np.argmax(REAL_Prediction)]
